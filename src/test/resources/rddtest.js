...
tests({
    ...
    version : function() {
        ...
        assertEquals("failure - strings are not equal", "EclairJS-nashorn 0.7 Spark 1.6.0", ver);
...
//		var ret = JSON.stringify(rdd.collect(function(i){return i===2}));
    ...
    testContext : function() {
        ...
        print("ret " + ret)
        var expectedClass = "{\"sc\":{\"version\":\"EclairJS-nashorn 0.7 Spark 1.6.0\",\"appName\":\"testapp\",\"master\":\"local[*]\"}}";
