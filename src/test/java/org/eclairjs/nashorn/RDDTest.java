...
//
//        assertEquals("failure - strings are not equal", "EclairJS-nashorn 0.1 Spark 1.6.0", ret.toString());
//
//    };
//
//    @Test
...
//     }
    @Test
    public void tcTests() throws Exception {
        ...
        // Test collect() - make sure collect works 1st as it is used by almost all the test cases.
        Object ret = ((Invocable)engine).invokeFunction("testTC");
    }
}
